...
{
    const char* pszTimestamp = "The twenty-first century is the age of digital technology";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed2.elspero.org");
        vSeeds.emplace_back("dnsseed3.elspero.org");
