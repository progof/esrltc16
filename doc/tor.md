...
config file):
	...
	HiddenServicePort 7393 127.0.0.1:7393
	HiddenServicePort 17373 127.0.0.1:17373

The directory can be different of course, but (both) port numbers should be equal to
your litecoind's P2P listen port (7393 by default).
...
and open port 7393 on your firewall (or use -upnp).
