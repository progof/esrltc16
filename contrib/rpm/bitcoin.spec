...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7392
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7393
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 17392
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 17373
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 7392
	%{_sbindir}/semanage port -d -p tcp 7393
	%{_sbindir}/semanage port -d -p tcp 17392
	%{_sbindir}/semanage port -d -p tcp 17373
